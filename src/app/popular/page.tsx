...
import { TrendingUp, Filter, Grid, List, Clock, Calendar, Timer } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-white mb-4 flex items-center">
              <TrendingUp className="h-10 w-10 text-red-500 mr-4" />
              Popular Anime
            </h1>
            <p className="text-gray-400 text-lg">
              Discover the most popular and trending anime
            </p>
          </div>

          {/* Trending Banner */}
          <div className="mb-8 bg-gradient-to-r from-red-900/20 to-orange-900/20 rounded-lg p-6 border border-red-800/30">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  {filteredAnime[0]?.popularity.toLocaleString()} views this week
                </p>
              </div>
            </div>
          </div>
