...
const formatJSTTime = (timestamp: number): string => {
  ...
  return (
    jstDate.toLocaleTimeString("en-US", {
      hour12: false,
      hour: "2-digit",
      minute: "2-digit",
      timeZone: "UTC",
...
const transformApiDataToSchedule = (
  apiData: ApiAnimeSchedule[]
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const apiResponse: ApiAnimeSchedule[] =
          await pageApi.getSchedulePageData();
