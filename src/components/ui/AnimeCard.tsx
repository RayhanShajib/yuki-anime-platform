          ...
          <div
            ...
            <div
              ...
              <div className="p-3">
                ...
                {/* Description */}
                <div className="mb-3">
                  <p className="text-gray-300 text-sm sm:text-base leading-[22px] line-clamp-3 overflow-hidden">
                    {anime.synopsis ||
                ...
                <div className="flex items-center space-x-2 sm:space-x-3">
                  <Link
                     href={`/watch/${anime.episodeId || anime.id}`}
                    className="btn-purple p-2 sm:p-3 rounded-full font-semibold flex items-center space-x-2 transition-colors"
                    onClick={handleClosePopup}>
                    <Play className="h-4 w-4 sm:h-5 sm:w-5" />
                  </Link>

                  <WatchlistDropdown animeId={anime.id} episodeId={anime.episodeId ?? undefined} iconOnly />
