...
export default function InfoComponent({ animeData }: InfoComponentProps) {
  ...
  const subCount =
    animeData.subTotal ||
    animeData.episodesData.filter((ep) => ep.type === "sub").length;
  const dubCount =
    animeData.dubTotal ||
    animeData.episodesData.filter((ep) => ep.type === "dub").length;
      ...
      <div className="h-[20rem] relative overflow-hidden min-w-full info-page-trailer md:h-[23rem] lg:h-[30rem]">
        ...
        <div className="absolute top-0 h-full trailer size-full object-cover pointer-events-none object-center trailer-blur-bg">
          <div className="w-full h-full info-trailer">
            {animeData.trailer && animeData.trailer.trim() !== "" ? (
              <iframe
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 xl:-mt-[200px] w-full info-page-main-content">
            ...
            <div className="space-y-6 md:space-y-0 md:flex md:gap-8">
              ...
              <div className="w-full md:w-80 xl:w-96 mt-8 md:mt-0 md:ml-4 flex-shrink-0">
                ...
                <div className="flex flex-col w-full max-h-[21.6rem] sm:max-h-[23rem] lg:max-h-[31rem] overflow-auto gap-2 sm:gap-3 lg:gap-4 px-1">
                  {animeData.characters.map((char, idx: number) => (
                    <div
                      key={char.name + idx}
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="h-10 w-10 rounded-full overflow-hidden flex-shrink-0">
                          ...
                          char.voiceActor.image.trim() !== "" ? (
                            <Image
                              src={char.voiceActor.image}
                              alt={char.voiceActor.name || "Voice Actor"}
                              width={40}
                              height={40}
                              className="object-cover w-full h-full"
                            />
          ...
          {activeTab === "episodes" && (
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-300">
                    Total Episodes: {animeData.episodes}
                  </p>
                </div>
              ...
              <div
                ...
                {animeData.episodesData.filter(
                  (episode) => episode.type === audioType
                ).length > 0 ? (
                      ...
                      <div
                        ...
                        <Link
                          ...
                          <div
                            ...
                            <Image
                              src={
                                episode.image && episode.image.trim() !== ""
                                  ? episode.image
                                  : `https://via.placeholder.com/400x225/333/white?text=Episode+${
                                      episode.ep_no || episode.id
                                    }`
                              }
                              alt={`${episode.title || "Episode"} screencap`}
                              fill
                              onError={(e) => {
                                (
                                  e.target as HTMLImageElement
                                ).src = `https://via.placeholder.com/400x225/333/white?text=Episode+${
                                  episode.ep_no || episode.id
                                }`;
                              }}
                              className={
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-gray-500">
                      Try switching to {audioType === "sub" ? "DUB" : "SUB"}{" "}
                      episodes or check back later.
                    </p>
                  </div>
                )}
              </div>
        ...
        <div className="w-full max-w-7xl mx-auto mt-3 pb-10 sm:pb-16">
          ...
          <Swiper
            ...
            {animeData.relatedAnime.slice(0, 10).map((animeItem) => (
          ...
          <div className="relative flex flex-col gap-4 md:gap-5 w-full z-20 mx-auto mt-8 lg:my-8 lg:mb-12 md:px-2 xl:px-0 !select-none">
            ...
            <div className="w-full max-w-7xl mx-auto mt-3 pb-10">
              <Swiper
                ...
                className="relations-swiper">
                {animeData.similarAnime.slice(0, 10).map((animeItem) => (
                  <SwiperSlide key={animeItem.id}>
                    <div className="relative">
                      <AnimeCard anime={animeItem} showPopup={true} />
                    </div>
